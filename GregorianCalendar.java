...
public class GregorianCalendar extends Calendar
{
    ...
    public int getActualMaximum(int field) {
        ...
        case WEEK_OF_MONTH:
        case DAY_OF_WEEK_IN_MONTH:
            return 0;//super.getActualMaximum(field);
        ...
        case YEAR:
             ...
             */
            {
                Calendar cal = null;//(Calendar)this.clone();
                cal.setLenient(true);
...
/////////////////////////////
    ...
    protected void computeFields() {
        int rawOffset = 0;//getTimeZone().getRawOffset();
        ...
        int dstOffset = 0;//getTimeZone().getOffset(era,year,month,date,dayOfWeek,millisInDay, monthLength(month), prevMonthLength(month)) - rawOffset;
...
/////////////////////////////
    ...
    protected void computeTime() {
        ...
        int zoneOffset = 0;//(stamp[ZONE_OFFSET] >= MINIMUM_USER_STAMP)
