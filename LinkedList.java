...
// 	    }
// 	    if(previous == null) {
// 		System.out.print("previous null: "); print();
// 		SPROCKET_setBreakPoint();
// 	    }
	    //	    check('r');
	    previous.next = next;
	...
	void check(char id) {
	    int nextAddr = SPROCKET_getAddress(next);
	    int prevAddr = SPROCKET_getAddress(previous);
	    if(nextAddr > 0xc00000 || prevAddr > 0xc00000)
		System.out.println(id + ":danger: " + nextAddr + " " + prevAddr);
	}

	void print(char t) {

	    System.out.print("\n" + t + "@" + Integer.toHexString(SPROCKET_getAddress(this)));
	    if(next != null)
		System.out.print(" n: @" + Integer.toHexString(SPROCKET_getAddress(next)));
	    else
		System.out.print(" n: null");

	    if(previous != null)
		System.out.print(" p: @" +  Integer.toHexString(SPROCKET_getAddress(previous)));
	    else
		System.out.print(" p: null");

	    if(data != null)
		System.out.println(" d: @" +  Integer.toHexString(SPROCKET_getAddress(data)));
	    else
		System.out.println(" d: null");

	}

	public static int SPROCKET_getAddress(Object o) {
	return 0;
	}

    }

    private static void SPROCKET_setBreakPoint() {
    }
	...
	public ListIterator listIterator(int index) {
	    ...
	    return new Iter(back, getEntry(index, size, head, tail), index, size, modCount);
	}
